...
class App(TKMT.ThemedTKinterFrame):
    def __init__(self):
        ...
        self.support_icon = ImageTk.PhotoImage(Image.open(resource_path("money.png")))
    ...
    def create_widgets(self):
        ...
        self.tab_control.add(self.support_frame, text=" Support", image=self.support_icon, compound='left')  # Add support tab
        ...
        program_title = ttk.Label(info_frame, text="Stormworks Connect v1.2.0.0", font=("Arial", 16))
